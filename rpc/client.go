...
func (op *requestOp) wait(ctx context.Context) (*jsonrpcMessage, error) {
	select {
	case <-ctx.Done():
		fmt.Println("================================!!!smpcwalletrpclog,requestOp.wait,1111,err =%v!!!!===========================================", ctx.Err())
		return nil, ctx.Err()
	case resp := <-op.resp:
		fmt.Println("================================!!!smpcwalletrpclog,requestOp.wait,22222,err =%v!!!!===========================================", op.err)
		return resp, op.err
	}
}
...
func DialContext(ctx context.Context, rawurl string) (*Client, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,DialContext,rawurl =%s,err =%v!!!!===========================================", rawurl, err)
		return nil, err
	}
	switch u.Scheme {
	case "http", "https":
...
func (io StdIOConn) Read(b []byte) (n int, err error) {
	...
	fmt.Println("================================!!!smpcwalletrpclog,StdIOConn.Read,a =%s,err =%v!!!!===========================================", a, err)
	return a, err
}
...
func (io StdIOConn) Write(b []byte) (n int, err error) {
	...
	fmt.Println("================================!!!smpcwalletrpclog,StdIOConn.Write,a =%s,err =%v!!!!===========================================", a, err)
	return a, err
}

func (io StdIOConn) Close() error {
	fmt.Println("================================!!!smpcwalletrpclog,StdIOConn.Close!!!!===========================================")
	return nil
}
...
func newClient(initctx context.Context, connectFunc func(context.Context) (net.Conn, error)) (*Client, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,newClient,err =%v!!!!===========================================", err)
		return nil, err
	}
...
func (c *Client) CallContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,CallContext,err =%v!!!!===========================================", err)
		return err
	}
	...
	case err != nil:
		return err
	case resp.Error != nil:
		fmt.Println("================================!!!smpcwalletrpclog,CallContext,err =%v!!!!===========================================", resp.Error)
		return resp.Error
	case len(resp.Result) == 0:
		fmt.Println("================================!!!smpcwalletrpclog,CallContext,err =%v!!!!===========================================", ErrNoResult)
		return ErrNoResult
	default:
...
func (c *Client) Subscribe(ctx context.Context, namespace string, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,client.Subscribe,err =%v!!!!===========================================", err)
		return nil, err
	}
	op := &requestOp{
...
func (c *Client) newMessage(method string, paramsIn ...interface{}) (*jsonrpcMessage, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,client.newMessage,err =%v!!!!===========================================", err)
		return nil, err
	}
...
func (c *Client) send(ctx context.Context, op *requestOp, msg interface{}) error {
	...
	case c.requestOp <- op:
		...
		err := c.write(ctx, msg)
		c.sendDone <- err
		fmt.Println("================================!!!smpcwalletrpclog,client.send,err =%v!!!!===========================================", err)
		return err
	case <-ctx.Done():
		// This can happen if the client is overloaded or unable to keep up with
		// subscription notifications.
		fmt.Println("================================!!!smpcwalletrpclog,client.send,err =%v!!!!===========================================", ctx.Err())
		return ctx.Err()
	case <-c.didQuit:
		fmt.Println("================================!!!smpcwalletrpclog,client.send,err =%v!!!!===========================================", ErrClientQuit)
...
func (c *Client) reconnect(ctx context.Context) error {
	...
	if err != nil {
		...
		fmt.Println("================================!!!smpcwalletrpclog,client.reconnect,err =%v!!!!===========================================", err)
		return err
	}
	select {
	...
	case <-c.didQuit:
		newconn.Close()
		fmt.Println("================================!!!smpcwalletrpclog,client.reconnect,err =%v!!!!===========================================", ErrClientQuit)
		return ErrClientQuit
	}
}
...
func (c *Client) handleNotification(msg *jsonrpcMessage) {
	...
	if err := json.Unmarshal(msg.Params, &subResult); err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,client.handleNotification,err =%v!!!!===========================================", err)
		return
	}
...
func (c *Client) read(conn net.Conn) error {
	...
	readMessage := func() (rs []*jsonrpcMessage, err error) {
		...
		if err = dec.Decode(&buf); err != nil {
			fmt.Println("================================!!!smpcwalletrpclog,client.read,err =%v!!!!===========================================", err)
			return nil, err
		}
		if isBatch(buf) {
...
func (sub *ClientSubscription) forward() (err error, unsubscribeServer bool) {
	...
	for {
		...
		case 1: // <-sub.in
			...
			if err != nil {
				fmt.Println("================================!!!smpcwalletrpclog,forward,err =%v!!!!===========================================", err)
				return err, true
			}
