...
func (hc *httpConn) Read(b []byte) (int, error) {
	<-hc.closed
	fmt.Println("================================!!!smpcwalletrpclog,httpConn.Read,err =%v!!!!===========================================", io.EOF)
	return 0, io.EOF
}
...
var DefaultHTTPTimeouts = HTTPTimeouts{
	ReadTimeout:  30 * time.Second, //30 --> 10000
	WriteTimeout: 30 * time.Second, //30 --> 10000
...
func DialHTTPWithClient(endpoint string, client *http.Client) (*Client, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,DialHTTPWithClient,err =%v!!!!===========================================", err)
		return nil, err
	}
	...
	if err != nil {
		if respBody != nil {
			...
			if _, err2 := buf.ReadFrom(respBody); err2 == nil {
				fmt.Println("================================!!!smpcwalletrpclog,client.sendHTTP,err =%v!!!!===========================================", fmt.Errorf("%v %v", err, buf.String()))
				return fmt.Errorf("%v %v", err, buf.String())
			}
		}
		fmt.Println("================================!!!smpcwalletrpclog,client.sendHTTP,err =%v!!!!===========================================", err)
		return err
	}
...
func (c *Client) sendBatchHTTP(ctx context.Context, op *requestOp, msgs []*jsonrpcMessage) error {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,client.sendBatchHTTP,err =%v!!!!===========================================", err)
		return err
	}
	defer respBody.Close()
...
func (hc *httpConn) doRequest(ctx context.Context, msg interface{}) (io.ReadCloser, error) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,client.doRequest,err =%v!!!!===========================================", err)
		return nil, err
	}
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		fmt.Println("================================!!!smpcwalletrpclog,client.doRequest,err =%v!!!!===========================================", errors.New(resp.Status))
...
func (srv *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet && r.ContentLength == 0 && r.URL.RawQuery == "" {
		fmt.Println("================================!!!smpcwalletrpclog,server.ServeHTTP,r.ContentLength == 0!!!!===========================================")
		return
	}
...
func (h *virtualHostHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("================================!!!smpcwalletrpclog,virtualHostHandler.ServeHTTP,err =%v!!!!===========================================", err)
	...
	fmt.Println("================================!!!smpcwalletrpclog,virtualHostHandler.ServeHTTP,err =%v!!!!===========================================", fmt.Errorf("invalid host specified"))
